...
from .utils import generate_order_number, get_total_by_vendor
        ...
        for i in cart_items:
            if i.fooditem.Vendor.user.email not in to_emails:
                ...
                context = {
                    ...
                    'vendor_subtotal': get_total_by_vendor(order, i.fooditem.Vendor.id)['subtotal'],
                    'tax_data':  get_total_by_vendor(order, i.fooditem.Vendor.id)['tax_dict'],
                    'vendor_grand_total': get_total_by_vendor(order, i.fooditem.Vendor.id)['grand_total'],
                }
                send_notification(mail_subject, mail_template, context)
