...
MIDDLEWARE = [
    ...
    'orders.request_object.RequestObjectMiddleware',   # CUSTOM MIDDLEWARE created 2 have access to the request in Models.py
]
...
#use for staic collection command (Deployment)
STATIC_ROOT = BASE_DIR / 'staticfiles'

#below code is used to load static files on page
STATICFILES_DIRS = [
    'static'
]
